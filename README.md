...
<body class="bg-morandi-bg text-text-dark">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const allMembers = {
                'c': [
                    '蕭蕙莉', '劉憶萍', '黃慧娟', '洪淑英', '林莉蓉', '黃玉惠', '洪婉茹', '黃湘雲', '蘇淑芳', '沈水雲', '李佳容',
                    '杜明道', '柯俊宏', '黃百春', '何佳宜', '孔雅雯', '林俊璋', '曾雅鈴', '蔡麗華', '吳佩書', '林宜靜', '吳佩蓉',
                    '吳宜家', '周小軒', '莊月慈', '許家綺', '蔡語涵', '許馨文', '高婉菁', '方月貞', '舒惠芳', '陳燕鈴', '蕭琇丰',
                    '張蕙茹', '林雁飛', '張敬忠'
                ],
                'a': [
                    '邵詩媛','方素秋', '李建成', '楊幸修', '林莉娟', '莊淑欽', '謝淑芬', '謝佳芬', '楊美珠', '陳惠琦', '王秋蓮', '葉雪法',
                    '邵詩媛', '蔡佩君', '楊竣欽', '黃士哲', '謝麗雯', '黃永男', '于錫倩', '王思薇', '林正雄', '曾毓珍', '吳靜儀',
                    '蕭景星', '林佳琪', '陳佳銘', '紀宗瀚', '黃秀玲', '林欣蓁', '陳昱瑾', '關哲彥', '陳怡靜', '劉婉榆', '李建賢',
                    '林靖傑', '林芯如', '林彣芷', '羅元廷', '唐愉君', '李林富'
                ],
                'r': [
                    '蘇春枝', '唐國庭', '李宜樺', '楊曉鏵', '陳美華', '姜郁成', '陳瑩純', '郭炳讓', '郭育淇', '曾麗娥', '黃小容',
                    '陳妙玉', '李畊緯', '陳義憲', '歐軒甫', '黃慧娟', '廖光明', '宋國漳', '盧稚涵', '丁恩惠', '黃榮田', '黃曉鳳',
                    '李佩汶', '朱逢源', '陳南丞', '陳宏睿', '黃柏豪', '劉怡姍', '陳又銘', '陳日為', '林哲光', '王弘偉', '林煒健',
                    '李國彰', '蘇江翰', '涂冠杰', '曾榮賦', '田宇峯', '王哲川', '王覲文'
                ],
                'e': [
                    '彭美惠', '陳姿伶', '鄭雅馨', '吳佩宜', '謝安妮', '吳泰清', '洪順興', '李振福', '吾秀蒂', '許雯萍', '康富期',
                    '林慧蓉', '曾建仁', '陳俊良', '林思維', '林佳珍', '胡恭寧', '高旭儒', '余宗興', '楊道欣', '施貿翔', '陳郁麗',
                    '廖仁傑', '余守純', '方惠姍', '劉欣岳', '韓龍疇', '江瑞益', '張鼎晨', '郭玉婷', '陳春丞', '陳經國', '鄭宛瑢',
                    '黃玉婷', '李育諭', '曾加儒', '閻姵君', '曾妍鳳', '張明閎', '劉家瑄', '洪綸吾', '楊傑宇', '王柏竣', '鄭鴻翔'
                ]
            };
